...
.markdown-body blockquote {
  padding: 0 1em;
  color: #6a737d;
  border-left: 0.25em solid rgba(102, 179, 255, 0.7);
}
...
.gt-container .gt-header-textarea:focus {
  background: rgba(168,171,171,0.5);
}
...
.gt-container .gt-header-preview {
  ...
  border-radius: 5px;
  border: 1px solid rgba(0, 0, 0, 0.1);
  background-color: rgba(168,171,171,0.4);
}
...
.gt-container .gt-comment-content:hover {
  -webkit-box-shadow: 0 0.625em 3.75em 0 rgba(68,71,71,0.7);
  box-shadow: 0 0.625em 3.75em 0 rgba(68,71,71,0.7);
}
...
.gt-container .gt-comment-admin .gt-comment-content {
  background-color: rgba(113,179,214,0.5);
  /* background-color: #1b1f23; */
}

/* Vừa thêm */
.gt-ico-reply .gt-svg svg{
  width: 130%;
  height: 130%;
}
.gt-ico-edit .gt-svg svg{
  width: 130%;
  height: 130%;
}
.gt-ico-heart .gt-svg svg{
  width: 130%;
  height: 130%;
}
